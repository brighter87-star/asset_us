...
# asset_us (US stocks) - 20:00 ET Mon-Fri (after after-market close)
0 20 * * 1-5 TZ=America/New_York cd $ASSET_US_DIR && python cron/daily_sync.py >> $ASSET_US_DIR/logs/daily_sync.log 2>&1
EOF
